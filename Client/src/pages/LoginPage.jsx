      ...
      <div className="hidden md:flex w-1/2 bg-[#0D0D15] relative overflow-hidden flex-col justify-between p-10">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          ...
          <p className="text-gray-400 text-sm mt-4 max-w-sm">
            Discover events that match your mood, powered by AI
          </p>
      ...
      <div className="w-full md:w-1/2 bg-[#0A0A0F] flex items-center justify-center p-8">
        <div className="bg-[#12121A] rounded-2xl border border-white/10 p-8 w-full max-w-md">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Sign in to your MoodGo account
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
            ...
            <div className="text-right">
              <span className="text-violet-400 text-xs cursor-pointer hover:underline">
                Forgot password?
              </span>
            </div>
            <button type="submit" className="bg-violet-600 hover:bg-violet-700 text-white rounded-xl px-6 py-3 font-semibold transition-all duration-200 shadow-lg shadow-violet-500/20 w-full text-sm">
              Login
            </button>
          </form>
